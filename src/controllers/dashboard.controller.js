...
function formatDate(value) { const date = toDate(value); return date ? new Intl.DateTimeFormat("ca-ES", { day: "2-digit", month: "2-digit", year: "numeric" }).format(date) : "Sense data"; }
...
export async function showDailyDashboard() {
  ...
  catch { root().innerHTML = `<div class="leads-error">No s'han pogut carregar les tasques.</div>`; }
}
